...
function ModalContent(props: { title: string; children: JSX.Element }) {
  return (
    <KobalteDialog.Portal>
      ...
      <KobalteDialog.Content class="z-20 fixed left-1/2 top-1/2 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 bg-gray-100 dark:bg-gray-800 rounded-md p-8 shadow data-[expanded]:animate-[dialog-show_300ms] data-[closed]:animate-[dialog-hide_300ms] text-gray-600 dark:text-gray-300">
        <div class="flex items-center justify-between gap-4">
          <KobalteDialog.Title class="text-xl text-gray-900 dark:text-gray-100 font-medium">
            {props.title}
          </KobalteDialog.Title>
